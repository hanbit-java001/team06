...
<link rel="stylesheet"
	href="/static/plugins2/css/jquery.fileupload-ui.css">
<link rel="stylesheet"
	href="/static/plugins/bootstrap/css/bootstrap.css">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript>
	<link rel="stylesheet"
		href="/static/plugins2/css/jquery.fileupload-noscript.css">
</noscript>
<noscript>
	<link rel="stylesheet"
		href="/static/plugins2/css/jquery.fileupload-ui-noscript.css">
</noscript>
</head>
<body>
			...
			<div class="row fileupload-buttonbar">
				<div class="col-lg-7">
					<span class="btn btn-success fileinput-button"> <i
						...
						id="upFile" type="file" name="files[]" multiple>
					</span>
					<button type="submit" class="btn btn-primary start">
						<i class="glyphicon glyphicon-upload"></i> <span>All Start
							upload</span>
					</button>
					<button type="reset" class="btn btn-warning cancel">
						<i class="glyphicon glyphicon-ban-circle"></i> <span>All Cancel
							upload</span>
					</button>
