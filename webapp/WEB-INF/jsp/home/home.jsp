...
<head>
  ...
  <link rel="shortcut icon" href="assets/images/logo-128x128-66.png" type="image/x-icon">
            ...
            <div class="mbr-navbar__container">
                <div class="mbr-navbar__column mbr-navbar__column--s mbr-navbar__brand">
                    <span class="mbr-navbar__brand-link mbr-brand mbr-brand--inline">
                        <span class="mbr-brand__logo"><a href="203.236.209.189:8282/"><img src="assets/images/logo-128x128-15.png" class="mbr-navbar__brand-img mbr-brand__img" alt="PoroPoro" title="Free Photo Sharing Gallery"></a></span>
                        <span class="mbr-brand__name"><a class="mbr-brand__name text-gray" href="203.236.209.189:8282/">Free Photo <br>Sharing Gallery</a></span>
                    </span>
                </div>
                ...
                <div class="mbr-navbar__column mbr-navbar__menu">
                    <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-right">
                        <div class="mbr-navbar__column">
                            <ul class="mbr-navbar__items mbr-navbar__items--right float-left mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active mbr-buttons--only-links"><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-white" href="https://mobirise.com"></a></li><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-black" href="203.236.209.189:8282/">GALLERY</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-black" href="203.236.209.189:8282/member/join">JOIN</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-black" href="203.236.209.189:8282/member/login">LOGIN</a></li></ul>
...
<section class="engine"><a rel="external" href="https://mobirise.com">top wysiwyg site development software download</a></section><section class="mbr-slider mbr-section mbr-section--no-padding carousel slide" data-ride="carousel" data-wrap="true" data-interval="5000" id="slider-2" style="background-color: rgb(255, 255, 255);">
    <div class="mbr-section__container">
        <div>
            ...
            <div class="carousel-inner" role="listbox">
                <div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height active" style="background-image: url(assets/images/slide115.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--center-center mbr-box__magnet--sm-padding mbr-after-navbar">
                        ...
                        <div class=" container">
                            ...
                            <div class="row">
                                ...
                                <div class="mbr-hero">
                                    <h1 class="mbr-hero__text">Free HD Photo Image</h1>

                                    <p class="mbr-hero__subtext"><strong>ë¬´ë£ ì¬ì§, ë²¡í° ì´ë¯¸ì§, ì¼ë¬ì¤í¸ ì´ë¯¸ì§ë¥¼ ê²ìíì¸ì.</strong><br></p>
                                </div>
                ...
                </div><div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height" style="background-image: url(assets/images/slide216.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--center-center mbr-box__magnet--sm-padding mbr-after-navbar">
                        ...
                        <div class=" container">
                            ...
                            <div class="row">
                                ...
                                <div class="mbr-hero">
                                    ...
                                    <p class="mbr-hero__subtext"><strong>ë¬´ë£ ì¬ì§, ë²¡í° ì´ë¯¸ì§, ì¼ë¬ì¤í¸ ì´ë¯¸ì§ë¥¼ ê²ìíì¸ì.</strong></p>
                                </div>
                ...
                </div><div class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--bg-adapted item dark center mbr-section--full-height" style="background-image: url(assets/images/slide317.jpg);">
                    <div class="mbr-box__magnet mbr-box__magnet--center-center mbr-box__magnet--sm-padding mbr-after-navbar">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="msg-box3-3" style="background-color: rgb(255, 255, 255);">
    ...
    <div class="mbr-section__container container mbr-section__container--first" style="padding-top: 31px;">
        <div class="mbr-header mbr-header--wysiwyg row">
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="mbr-header__text">íê·¸ë³ë¡ ì¬ì§ì ê²ìíì¸ì</h3>
    ...
    <div class="mbr-section__container container mbr-section__container--last" style="padding-bottom: 31px;">
        <div class="row">
            <div class="mbr-article mbr-article--wysiwyg col-sm-8 col-sm-offset-2"><p>ê°ì   ê±´ê°  ê±´ì¶ë¬¼   ê³¼í/ê¸°ì   êµì¡  êµíµ  ëë¬¼&nbsp;</p><p>ë°°ê²½/ì§ê° ë·°í°/í¨ì ì¬ë ì¬ì/ê¸ìµ ì°ì/ê¸°ì  ì¤í¬ì¸ &nbsp;</p><div>ì¬í/í´ê° ìì ìì ìì°  ì¥ì/ê¸°ë  ì¢êµ  ì»´í¨í°/ì»¤ë®¤ëì¼ì´ì</div></div>
        </div>
    </div>

</section>

<section class="mbr-gallery mbr-section mbr-section--no-padding" id="gallery1-4" style="background-color: rgb(204, 204, 204);">
    <!-- Gallery -->
...
<section class="mbr-gallery mbr-section mbr-section--no-padding" id="gallery1-5" style="background-color: rgb(204, 204, 204);">
    <!-- Gallery -->
    <div class=" mbr-gallery-layout-default">
        <div>
            <div class="row mbr-gallery-row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-5" data-slide-to="2" data-toggle="modal">
                        <img alt="" src="assets/images/slide3-small.jpg">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-5" data-slide-to="3" data-toggle="modal">
                        <img alt="" src="assets/images/slide4-small.jpg">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-5" data-slide-to="4" data-toggle="modal">
                        <img alt="" src="assets/images/slide5-small.jpg">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-5" data-slide-to="5" data-toggle="modal">
                        <img alt="" src="assets/images/slide6-small.jpg">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-5" data-slide-to="6" data-toggle="modal">
                        <img alt="" src="assets/images/slide7-small.jpg">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    ...
                    <a href="#lb-gallery1-5" data-slide-to="7" data-toggle="modal">
                        <img alt="" src="assets/images/slide8-small.jpg">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div>
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="social-buttons1-6" style="background-color: rgb(255, 255, 255);">


    <div class="mbr-section__container container">
        <div class="mbr-header mbr-header--inline row" style="padding-top: 54.4px; padding-bottom: 0px;">
            <div class="col-sm-4">
...
<footer class="mbr-section mbr-section--relative mbr-section--fixed-size" id="footer1-9" style="background-color: rgb(255, 255, 255);">

    <div class="mbr-section__container container">
        <div class="mbr-footer mbr-footer--wysiwyg row" style="padding-top: 49.2px; padding-bottom: 49.2px;">
            <div class="col-sm-12">
                <p class="mbr-footer__copyright">Copyright (c) 2016 PoroPoro Service</p>
            </div>
        </div>
    </div>
</footer>
